...
from coreai_models.diffusion.flux2 import (
    ...
    dummy_flux2_transformer_edit_2ref,
    dummy_flux2_transformer_edit_2ref_512,
...
FLUX2_COMPONENTS: dict[str, ComponentSpec] = {
    ...
    # Two-reference in-context edit transformers (combine / place subject across images).
    "transformer_edit_2ref": ComponentSpec(
        asset_name="Transformer_edit_2ref",
        input_names=(
            "hidden_states",
            "encoder_hidden_states",
            "timestep",
        ...
        output_names=("output",),
        wrapper_fn=lambda p: Flux2TransformerPrecomputedRoPEWrapper(p.transformer),
        dummy_fn=dummy_flux2_transformer_edit_2ref,
        quantizable=True,
    ),
    "transformer_edit_2ref_512": ComponentSpec(
        asset_name="Transformer_edit_2ref_512",
        input_names=(
            "hidden_states",
            "encoder_hidden_states",
            "timestep",
        ...
        output_names=("output",),
        wrapper_fn=lambda p: Flux2TransformerPrecomputedRoPEWrapper(p.transformer),
        dummy_fn=dummy_flux2_transformer_edit_2ref_512,
        quantizable=True,
    ),
    "text_encoder": ComponentSpec(
        asset_name="TextEncoder",
